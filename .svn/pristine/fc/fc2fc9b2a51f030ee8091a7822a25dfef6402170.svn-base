...
namespace HomotorDepotMgr.Utility
{
    public class SQLiteDBHelper
    {
        ...
        public string GetCurrentDirectory()
        {
            ...
            return Path.GetDirectoryName(root.ToString());
        }

        public SQLiteDBHelper()
        {
            connectionString = "Data Source=" + GetCurrentDirectory() + @"\appDB.db";
            //string datasource = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().GetName().CodeBase) + @"\appDB.db";
            //connectionString = "Data Source=" + datasource + ";Pooling=true;FailIfMissing=false";
        }

        public SQLiteDBHelper(string dbName)
        {
            string datasource = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().GetName().CodeBase) + @"\" + dbName + ".db";
            connectionString = "Data Source=" + datasource + ";Pooling=true;FailIfMissing=false";
        }
